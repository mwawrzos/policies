...
[mlperf_logging.mllog package](https://github.com/mlcommons/logging/tree/master/mlperf_logging/mllog).
...
Submitters must run the [package_checker](https://github.com/mlcommons/logging/tree/master/mlperf_logging/package_checker)
and the [system_description_checker](https://github.com/mlcommons/logging/tree/master/mlperf_logging/system_desc_checker) tools
